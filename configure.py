...
ninja_file.build("build/eltail.jp.elf", "make_elf ", o_files)
ninja_file.build("build/eltail.jp.z64", "make_z64 ", "build/eltail.jp.elf")
ninja_file.build("build/eltail.jp.ok", "make_expected ", "build/eltail.jp.z64")
